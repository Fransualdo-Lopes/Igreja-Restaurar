        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="relative">
                    <div className="aspect-[4/5] w-full max-w-md mx-auto bg-gray-800 relative z-10">
                         <img 
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-8">
                        <div>
                            ...
                            <span className="text-sm text-gray-400 uppercase tracking-wider">Ano de História</span>
                        </div>
                        <div>
                            <span className="block text-4xl font-serif text-[#D64531] mb-1">100+</span>
                            <span className="text-sm text-gray-400 uppercase tracking-wider">Membros</span>
                        </div>
                        <div>
                            <span className="block text-4xl font-serif text-[#D64531] mb-1">2</span>
                            <span className="text-sm text-gray-400 uppercase tracking-wider">Projetos Sociais</span>
                        </div>
                    </div>
                </div>
            </div>
