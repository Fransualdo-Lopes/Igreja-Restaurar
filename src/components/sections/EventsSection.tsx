      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          <div>
            ...
            <h3 className="text-4xl md:text-5xl font-serif text-gray-900 dark:text-white transition-colors">Próximos Eventos</h3>
          </div>
          <a href="#" className="hidden md:block text-gray-500 dark:text-gray-400 hover:text-[#D64531] dark:hover:text-[#D64531] border-b border-gray-300 dark:border-gray-700 hover:border-[#D64531] pb-1 transition-all">
          ...
          {events.map((event) => (
            <div key={event.id} className="bg-white dark:bg-gray-800 p-8 rounded-none border-l-4 border-[#D64531] shadow-sm hover:shadow-lg transition-all duration-300 group">
              <div className="flex justify-between items-start mb-6">
                ...
                <Calendar className="text-gray-300 dark:text-gray-600 group-hover:text-[#D64531] transition-colors" size={24} />
              </div>
              <h4 className="text-2xl font-serif text-gray-900 dark:text-white mb-2 transition-colors">{event.title}</h4>
              <div className="space-y-1 text-gray-600 dark:text-gray-300 transition-colors">
        ...
        <div className="mt-8 text-center md:hidden">
           <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-[#D64531] border-b border-gray-300 dark:border-gray-700 hover:border-[#D64531] pb-1 transition-all">
            Ver calendário completo
          </a>
        </div>
      </div>
