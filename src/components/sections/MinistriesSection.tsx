...
export const MinistriesSection: React.FC = () => {
  ...
  const ministries: (Ministry & { icon: React.ReactNode })[] = [
    ...
    },
    {
      ...
      icon: <Music size={24} />,
      team: [
        { name: 'Rozenir Reis', role: 'Vocal', imageUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=200&auto=format&fit=crop' },
        { name: 'Rose Santos', role: 'Vocal', imageUrl: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=200&auto=format&fit=crop' },
        { name: 'Eduarda Almeida', role: 'Vocal', imageUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=200&auto=format&fit=crop' },
        { name: 'Raiane Matos', role: 'Vocal', imageUrl: 'https://images.unsplash.com/photo-1525134479668-1bee4c7c6a39?q=80&w=200&auto=format&fit=crop' },
        { name: 'Rafaela Lopes', role: 'Vocal', imageUrl: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?q=80&w=200&auto=format&fit=crop' },
        { name: 'Gerson Diego', role: 'Bateria', imageUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop' },
        { name: 'Fabio Arruda', role: 'Guitarra', imageUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=200&auto=format&fit=crop' },
        { name: 'Fransualdo Lopes', role: 'Violão', imageUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=200&auto=format&fit=crop' },
        { name: 'Marcos Jhow', role: 'Contra Baixo', imageUrl: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=200&auto=format&fit=crop' },
      ]
    },
    {
      id: 'intercession',
