...
const featuredSermon: Sermon = {
  ...
  preacher: "Pr. Pedro",
  date: "Domingo, 25 Fev",
  thumbnailUrl: "https://images.unsplash.com/photo-1515162305285-0293e4767cc2?q=80&w=2671&auto=format&fit=crop",
  videoUrl: "#"
};
...
const recentSermons: Sermon[] = [
  {
    ...
    preacher: "Pra. Kerly",
    date: "18 Fev",
    thumbnailUrl: "https://images.unsplash.com/photo-1490730141103-6ca27d91461f?q=80&w=2670&auto=format&fit=crop"
  },
  {
    id: '2',
    ...
    preacher: "Pr. Pedro",
    date: "11 Fev",
    thumbnailUrl: "https://images.unsplash.com/photo-1504052434139-4415555d03a3?q=80&w=2670&auto=format&fit=crop"
  },
  {
    id: '3',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed transition-colors">
                Assista a mensagem ministrada no último Culto de Celebração. Uma palavra de renovação e esperança baseada nas Escrituras.
              </p>
